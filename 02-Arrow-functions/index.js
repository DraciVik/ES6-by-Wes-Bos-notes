...
// We don't use arrow functions when we need to add a prototype method. 
...
// Car.prototype.sumarize = () => {
//     return `This car is a ${this.make} in the color ${this.color}`;
// };
// In this case "this" is undefined. We need to use a regular function.

// We don't use arrow functions when we need an arguments object
